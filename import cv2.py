...
notes = {
    "thumb": "do.mp3",    # Baş parmak - C notası
    "index": "re.mp3",    # İşaret parmağı - D notası
    "middle": "mi.mp3",   # Orta parmak - E notası
    "ring": "fa.mp3",     # Yüzük parmak - F notası
    "pinky": "sol.mp3"     # Serçe parmak - G notası
}
